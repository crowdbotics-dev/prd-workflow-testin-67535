...
## Project Structure
    ...
    ├── prd_workflow_testin_67535  # Django project configurations
...
1. Clone this repo and `cd prd_workflow_testin_67535`
...
2. Clone this repo and `cd prd_workflow_testin_67535`
